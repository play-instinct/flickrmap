...
function makeGeoJson(){
    ...
    state.geojson.features.forEach(function(marker) {
        ...
        .setHTML(`<figure class="effect-goliath"><img src="${marker.properties.thumb_url}" alt="img23"/>
                        <figcaption><p>View Details</p><a href="#" class="view-link">View more</a></figcaption></figure>`)).addTo(map);
